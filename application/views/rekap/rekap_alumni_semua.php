...
<h4><p align="center">LAPORAN DATA ALUMNI</p></h4>
<h4><p>Di Cetak Hari
<?php
 $hari   = date('l');
...
<h4>Jumlah Laki-Laki: <?php $query = $this->db->query("SELECT * FROM alumni, pendaftar where alumni.id_pendaftar = pendaftar.id_pendaftar AND pendaftar.jenis_kelamin = 'Laki-Laki'");
    		if($query->num_rows() > 0){
				echo $query->num_rows();
			}else{
				echo 0;
...
?> <br>
Jumlah Perempuan:  <?php $query = $this->db->query("SELECT * FROM alumni, pendaftar where alumni.id_pendaftar = pendaftar.id_pendaftar AND pendaftar.jenis_kelamin = 'Perempuan'");
    		if($query->num_rows() > 0){
				echo $query->num_rows();
			}else{
				echo 0;

...
<h4><p align="center">LAPORAN DATA PENDAFTAR AKUN DARI (<?php echo tgl_indo($_POST['tanggal1']); ?> Hingga <?php echo tgl_indo($_POST['tanggal2']); ?>)</p></h4>
<h4><p>Di Cetak Hari
<?php
 $hari   = date('l');
...
<table border="1" align="center" class="table1">
    <tr>
        ...
        <?php $no = 1; foreach ($data as $key):?>
			...
			<td>
        	<img src="<?php echo base_url().'assets/uploads/images/'.$key['pas_foto'];?>" alt="" width="70px">
			</td>

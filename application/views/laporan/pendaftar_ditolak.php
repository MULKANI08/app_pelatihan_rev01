...
<div class="page-wrapper">
    	<div class="container-fluid">
        	<div class="row page-titles">
					...
					Laporan Data Pendaftar Pelatihan Tidak Diterima Berdasarkan Tanggal Daftar
					</h4>
				<br>
				<div class="col-md-12 col-8 align-self-center">
					<form action="<?= site_url('laporan/rekap_pendaftar_ditolak') ?>" method="post" target="_blank">
					...
					<span>
			<a target="_blank" style="padding: 8px 225px; font-weight: bold; background-color: #000000; color: #fff; border-radius: 10px;" href="<?php echo base_url();?>laporan/rekap_semua_pendaftar_ditolak">Cetak Semua</a>
			</span>
        </div>
			</div>

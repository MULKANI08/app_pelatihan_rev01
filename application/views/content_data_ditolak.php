        ...
        <div class="page-wrapper">
          <div class="container-fluid">
            <div class="row">
              ...
              <div>
             <br>
			<a target="_blank" class="float-right" style="padding: 5px 10px; background-color: #fc4b6c; color: #fff; border-radius: 10px; margin-bottom: 5px;" href="<?php echo base_url();?>laporan/rekap_pendaftar_ditolak_admin">Cetak Data</a>
              </div>
              <?php echo $output?>
            </div>
          </div>
